...
func main() {
	//this expression is checking for a string that starts with 0x, and that contaiins numeric values from  0-9, and letters that are capital or lowercase from A-F, and also making sure that character length is only 40 after the 0x
